...
| :--- | :--- | :--- |
| **Biomedical AI** | `Done` | `Medical Image Analysis`, `Biosignal Processing & Analysis`, `Biometrics` |
| **Machine Learning** | `Done` | `Deep Learning`, `Pattern Recognition`, `Digital Image Processing` |
